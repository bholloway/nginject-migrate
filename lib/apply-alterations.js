...
function applyAlterations(content, pending, options) {
  ...
  var generator = options.sourceMap && new Generator() || null;
 ...
 * @param {{line:number, column:number}} loc A location with 0-based numeric fields
 * @returns {{line:number, column:number}} A location with 1-based numeric fields
 */
